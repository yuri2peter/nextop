...
import { CloudUpload, Paperclip, Trash2 as RemoveIcon } from "lucide-react";
import {
  type Dispatch,
  type SetStateAction,
  createContext,
...
export const EnhancedFileUploader = forwardRef<
  HTMLDivElement,
  FileUploaderProps &
    React.HTMLAttributes<HTMLDivElement> & { description?: string }
>(
  (
    { value, className, description = "SVG, PNG, JPG or GIF", ...props },
    ref,
  ) => {
    return (
      <FileUploader
